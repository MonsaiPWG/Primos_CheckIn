    ...
    <nav className="flex items-center">
      ...
      <ul className="hidden md:flex space-x-6 mx-6">
        <li>
          <Link 
            href="/" 
            className={`text-lg font-medium ${pathname === '/' ? 'text-white' : 'text-gray-400 hover:text-white transition-colors'}`}
          >
            Mining
          </Link>
        </li>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-md shadow-lg p-3">
            <ul className="flex flex-col space-y-2">
              <li>
                <Link 
                  href="/" 
                  className={`block w-full text-lg font-medium py-2 px-3 rounded ${pathname === '/' ? 'text-white bg-gray-700' : 'text-gray-400 hover:text-white hover:bg-gray-700 transition-colors'}`}
